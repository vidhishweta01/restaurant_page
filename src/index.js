...
function component1() {
    ...
    about_us.setAttribute('class','about-us w-25 px-0 py-2 btn-dark');
    ...
    contact_us.setAttribute('class','contact-us w-25 px-0 py-2 btn-dark');
